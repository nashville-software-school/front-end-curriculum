...
# Group Project 2: Battleship
### Description:  Create a working 2 player battleship game.

### MVP Requirements:
1.  Game must keep track of Player 1 and Player 2
2.  Each player gets 5 ships(destroyer(2 holes), submarine(3 holes), cruiser(3 holes), battleship(4 holes), carrier(5 holes)) which they can place on their game board where they want
2.  Players should be able to see a representation of their board and the board they are attacking
3.  Use firebase to keep track of player moves

### Stretch Goals:
1.  Players should be able to rotate their ships either horizontally or vertically
2.  Each player should be able to use their own computer to play
3.  Leaderboard
